...
public:
    ...
    void ShowNum (TTF_Font *gFont, SDL_Color textColor, SDL_Renderer *gRenderer  );
    void ShowNum2 (TTF_Font *gFont, SDL_Color textColor, SDL_Renderer *gRenderer  );
    void ShowNum3 (TTF_Font *gFont, SDL_Color textColor, SDL_Renderer *gRenderer  );
